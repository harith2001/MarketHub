  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      const fetchedProducts = [
        { id: 1, name: 'Apple', category: 'Fruits', price: 1.5, stock: 100, status: 'Active' },
        { id: 2, name: 'Laptop', category: 'Electronics', price: 1200, stock: 30, status: 'Inactive' },
        { id: 3, name: 'Milk', category: 'Dairy', price: 2.5, stock: 200, status: 'Active' },
      ];
